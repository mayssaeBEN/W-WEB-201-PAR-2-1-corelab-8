    ...
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      ...
      <div className="container-fluid px-4 py-4" style={{ maxWidth: 1100 }}>
        ...
        <div className="row g-3 mb-4">
          {[
            { label: 'Total résultats', value: grades.length, color: '#3b82f6', icon: '📋' },
            { label: 'Réussis', value: passed, color: '#16a34a', icon: '✅' },
            { label: 'Échoués', value: failed, color: '#dc2626', icon: '❌' },
            { label: 'Moyenne générale', value: `${avg}%`, color: '#f97316', icon: '🎯' },
          ].map(s => (
